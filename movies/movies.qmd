...
axes[0].set(xlim=[-2.5, 2.5], ylim=[-2.5, 2.5],
             xlabel="Posterior median, 50%, and 95% interval",
             ylabel="True parameter value",
             title="Checking the $\\alpha_j$'s")
axes[0].plot([-2, 2], [-2, 2], color="0.7")
...
axes[1].set(xlim=[-2.5, 2.5], ylim=[-2.5, 2.5],
             xlabel="Posterior median, 50%, and 95% interval",
             ylabel="True parameter value",
             title="Checking the $\\beta_k$'s")
axes[1].plot([-3, 3], [-3, 3], color="0.7")
...
axes[0].set(
            xlabel="Raw average rating for movie j",
            ylabel="True $a_j$",
...
axes[1].plot(a_post_median[crime_mask], a_true[crime_mask],
                "C1o", label="Crime movies")
axes[1].set(
            xlabel="Posterior median estimate for movie j",
            ylabel="True $a_j$",
