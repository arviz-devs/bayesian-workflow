...
image: social_cards/roaches.png
author: "Aki Vehtari"
date: 2017-01-10
date-modified: today
date-format: iso
...
model for counts and skip the Poisson model.
...
/ individual), it's not easy to make a generic approach for `bambi`,
and thus we illustrate the approach with direct Stan model code and `cmdstanpy`.
